...
const asyncRouterMapList = [
    ...
    // },
    {
			...
			children:[
				{path:'/knowledge/syntax',component:_import_views('Knowledge/Syntax'),name:'常用语法'},
				{path:'/knowledge/life-cycle',component: _import_views("Knowledge/LifeCycle"), name:'生命周期'},
				{path:'/knowledge/model',component: _import_views("Knowledge/Model"), name:'双向绑定'},
				{path:'/knowledge/create-component',component: _import_views("Knowledge/CreateComponent"),name:'组件写法'},
				{path:'/knowledge/redux',component: _import_views("Knowledge/ReduxText"),name:'redux'},
				{path:'/knowledge/useState',component:_import_views('TableCharts/useState'),name:'useState用法'},
				{path:'/knowledge/reactHook',component:_import_views('TableCharts/reactHook'),name:'React Hook'}
			]  
    },
    // {
    //     path: '/components',
    ...
    //     ]
		// },
		{
			...
			redirect:'/charts/echarts',
			children:[
				{path:'/charts/echarts',component:_import_views('TableCharts/Echarts'),name:'echarts图表'},
				{path:'/charts/table',component:_import_views('TableCharts/Table'),name:'table表格'},
				{path:'/charts/tree',component:_import_views('TableCharts/TreeTable'),name:'树形数据'},
			]
		},
    // {
    //     path: '/error',
